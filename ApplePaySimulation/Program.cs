...
namespace ApplePaySimulation
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddHangFireDependencies(builder.Configuration);
            builder.Services.AddEmailSettingsDependencies(builder.Configuration);
            builder.Services.AddEmailServiceDependencies();
